...
- Harden plotting/type helpers: improve axes handling in `pairs_copula_data`, ensure uniform-margin adjustment uses arrays, and adjust mypy config to target Python 3.11 and scope checks to `src` only.
